package com.zjh.project.graphblog.service.impl;

import com.github.pagehelper.PageHelper;
import com.zjh.project.graphblog.dao.AttachVoMapper;
import com.zjh.project.graphblog.dto.MetaDto;
import com.zjh.project.graphblog.exception.TipException;
import com.zjh.project.graphblog.modal.Bo.ArchiveBo;
import com.zjh.project.graphblog.modal.Vo.*;
import com.zjh.project.graphblog.service.ISiteService;
import com.zjh.project.graphblog.utils.DateKit;
import com.zjh.project.graphblog.utils.TaleUtils;
import com.zjh.project.graphblog.utils.backup.Backup;
import com.zjh.project.graphblog.constant.Const;
import com.zjh.project.graphblog.controller.admin.AttachController;
import com.zjh.project.graphblog.dao.CommentVoMapper;
import com.zjh.project.graphblog.dao.ContentVoMapper;
import com.zjh.project.graphblog.dao.MetaVoMapper;
import com.zjh.project.graphblog.dto.Types;
import com.zjh.project.graphblog.modal.Bo.BackResponseBo;
import com.zjh.project.graphblog.modal.Bo.StatisticsBo;
import com.zjh.project.graphblog.utils.ZipUtils;
import com.zjh.project.graphblog.modal.Vo.*;
...
public class SiteServiceImpl implements ISiteService {
    ...
    public List<MetaDto> metas(String type, String orderBy, int limit){
        ...
        if (StringUtils.isNotBlank(type)) {
            ...
            if(limit < 1 || limit > Const.MAX_POSTS){
                limit = 10;
            }
