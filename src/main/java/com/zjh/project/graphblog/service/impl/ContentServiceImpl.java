...
import com.zjh.project.graphblog.modal.Vo.ContentVoExample;
import com.zjh.project.graphblog.service.IContentService;
import com.zjh.project.graphblog.service.IMetaService;
import com.zjh.project.graphblog.service.IRelationshipService;
import com.zjh.project.graphblog.utils.DateKit;
import com.zjh.project.graphblog.utils.TaleUtils;
import com.zjh.project.graphblog.utils.Tools;
...
public class ContentServiceImpl implements IContentService {
    ...
    public void publish(ContentVo contents) {
        ...
        if (titleLength > Const.MAX_TITLE_COUNT) {
            throw new TipException("文章标题过长");
        }
        int contentLength = contents.getContent().length();
        if (contentLength > Const.MAX_TEXT_COUNT) {
