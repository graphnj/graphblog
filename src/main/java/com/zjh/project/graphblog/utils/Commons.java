package com.zjh.project.graphblog.utils;
...
public final class Commons {
    ...
    public static String site_url(String sub) {
        ...
        String url= site_option("site_url") + sub;
        return url;
    }
    ...
    public static String site_option(String key, String defalutValue) {
        ...
        String str = Const.initConfig.get(key);
    ...
    public static List<MetaDto> categries() {
        return categries(Const.MAX_POSTS);
    }
    ...
    public static Map<String, String> social() {
        ...
        map.put("weibo", Const.initConfig.get(prefix + "weibo"));
        map.put("zhihu", Const.initConfig.get(prefix + "zhihu"));
        map.put("github", Const.initConfig.get(prefix + "github"));
        map.put("twitter", Const.initConfig.get(prefix + "twitter"));
        return map;
    }
