...
import com.zjh.project.graphblog.modal.Vo.LogVo;
...
import com.zjh.project.graphblog.utils.GsonUtils;
...
public class IndexController extends BaseController {
    ...
    public RestResponseBo saveProfile(@RequestParam String screenName, @RequestParam String email, HttpServletRequest request, HttpSession session) {
        ...
        if (StringUtils.isNotBlank(screenName) && StringUtils.isNotBlank(email)) {
            ...
            //更新session中的数据
            UserVo original= (UserVo)session.getAttribute(Const.LOGIN_SESSION_KEY);
            original.setScreenName(screenName);
            original.setEmail(email);
            session.setAttribute(Const.LOGIN_SESSION_KEY,original);
        }
